    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = amor_opt( 'amor_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo amor_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( amor_featured_post_cat() ){
                                echo '<span class="entry__category">'.amor_featured_post_cat().'</span>';
                            }
                            ?>

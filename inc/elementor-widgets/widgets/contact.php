...
/**
 *
 * amor elementor about page section widget.
 *
 * @since 1.0
 */
class Amor_Contact extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'amor' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'amor' ),
                ...
                'fields'  => [
                    [
                        ...
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'amor' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'amor' ),
                        'type'    => Controls_Manager::TEXTAREA,
                        'default' => esc_html__( 'Write something...', 'amor' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'amor' ),
                        'type'  => Controls_Manager::ICON,
                        'options' => amor_themify_icon()
                    ]
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'amor' ),
            ]
        );
        $this->add_control(
            'contact_form_title',
            [
                'label'     => esc_html__( 'Contact Form Title', 'amor' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Get in Touch', 'amor')
            ]
        );
        $this->add_control(
            'contact_formshortcode',
            [
                'label'     => esc_html__( 'Form Shortcode', 'amor' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true
            ]
        );
        ...
        $this->start_controls_section(
            'style_content_color', [
                'label' => __( 'Style Content Color', 'amor' ),
        ...
        $this->add_control(
            'color_title', [
                'label'     => __( 'Right Text Title Color', 'amor' ),
        ...
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Right Text Sub Title Color', 'amor' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [

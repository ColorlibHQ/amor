 ...
 */
	...
	class amor_Enqueue{
		...
		public function amor_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'amor_frontend_enqueue_scripts', ) );
		}

		public function amor_frontend_enqueue_scripts( ){

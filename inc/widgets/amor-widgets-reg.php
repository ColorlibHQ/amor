...
function amor_widgets_init() {
    ...
    register_sidebar(array(
        'name'          => esc_html__('Sidebar widgets', 'amor'),
        'description'   => esc_html__('Place widgets in sidebar widgets area.', 'amor'),
        'id'            => 'sidebar_widgets',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer One', 'amor' ),
			'id'            => 'footer-1',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer Two', 'amor' ),
			'id'            => 'footer-2',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer Three', 'amor' ),
			'id'            => 'footer-3',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer Four', 'amor' ),
			'id'            => 'footer-4',

...
----------------------------------------*/
class amor_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('amor_instagram_photo',esc_html__('[ Amor ] Intagram Photo','amor'),array(
			'description' => esc_html__('Amor Instagram Photo Widget','amor'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'amor');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'amor'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'amor'); ?></label>
...
if(!function_exists('amor_instagram_widgets')):
	function amor_instagram_widgets(){
		register_widget('amor_instagram_photo');
	}
	add_action('widgets_init','amor_instagram_widgets');
endif;

...
// image default alt
if( !function_exists( 'amor_img_default_alt' ) ){
	function amor_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'amor_img_tag' ) ){
	function amor_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'amor_anchor_tag' ) ){
	function amor_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'amor_heading_tag' ) ){
	function amor_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'amor_paragraph_tag' ) ){
	function amor_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'amor_other_tag' ) ){
	function amor_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'amor_button_element ' ) ){
	function amor_button_element( array $args ){
